   ...
   <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
       ...
       <form action="{{route('backend_produit_store_size',['id'=>$produit->id])}}" method="POST">
           @csrf
             <div class="row">
                 <div class="col-8">
                     <label for="type_id">Sélectionner un type de taille</label>
                     <select class="form-control change_type"  name="type_id" data-id_produit="{{$produit->id}}" id="type_id">
       ...
       <table class="table table-striped">
           ...
           @foreach($produit->tailles as $taille)
               <tr>
                   ...
                   <td>
                       <a href="#" class="btn btn-danger btn-sm remove_size" data-id_produit="{{$produit->id}}"
