    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{route('view_by_cat',['id'=>$p->categorie->parent->id])}}">{{$p->categorie->parent->nom}}</a></li>
            @endif
            @if($p->categorie)
            ...
            <div class="row justify-content-between">
                <div class="col-6">
                    <div class="card mb-4 box-shadow">
                        <img class="card-img-top" src="{{asset('storage/uploads/'.$p->photo_principale)}}" alt="Card image cap">
                        ...
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-end">
                                    <div class="btn-group">
                                        <a href="{{route('view_by_product',['id'=>$recommandation->id])}}" class="btn btn-sm btn-outline-secondary"><i class="fas fa-eye"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
