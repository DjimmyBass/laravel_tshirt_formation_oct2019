    ...
    @foreach($produits as $produit)
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 box-shadow">
                                <a href="{{route('view_by_product',['id'=>$produit->id])}}">
                                <img src="{{asset('storage/uploads/'.$produit->photo_principale)}}"
                                     class="card-img-top img-fluid" alt="Responsive image"></a>
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="{{route('view_by_product',['id'=>$produit->id])}}" class="btn btn-sm btn-outline-secondary"><i class="fas fa-eye"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
