                ...
                <form action="{{route('commande_store_adresse')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="text" class="form-control" id="email" name="email" value="{{$adresse->email ?? old('email')}}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="address2" name="address2" value="{{$adresse->adresse2 ?? old('adresse2')}}">
                    </div>

                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <label for="ville">Votre ville <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ville" name="ville" value="{{$adresse->ville ?? old('ville')}}">
                        </div>
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <select class="custom-select d-block w-100" id="country" name="pays"  required>
                                ...
                                <option
@if(old('pays') == $code || (isset($adresse->pays) && $adresse->pays == $code))
                                selected @endif
                                value="{{$code}}">{{$p}}
                                </option>
                                @endforeach
